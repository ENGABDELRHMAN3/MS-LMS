...
<div class="row g-5 g-xl-8">
											...
											<div class="card card-xl-stretch mb-xl-8">
												...
												<div class="card-body d-flex align-items-center pt-3 pb-0">
													<div class="d-flex flex-column flex-grow-1 py-2 py-lg-13 me-2">
														<a href="#" class="fw-bold text-dark fs-4 mb-2 text-hover-primary">الدروس النصية</a>
										...
										<div class="col-xl-4">
											...
											<div class="card card-xl-stretch mb-xl-8">
												...
												<div class="card-body d-flex align-items-center pt-3 pb-0">
													<div class="d-flex flex-column flex-grow-1 py-2 py-lg-13 me-2">
														<a href="#" class="fw-bold text-dark fs-4 mb-2 text-hover-primary">الدروس المرئية</a>
										...
										<div class="col-xl-4">
											...
											<div class="card card-xl-stretch mb-5 mb-xl-8">
												...
												<div class="card-body d-flex align-items-center pt-3 pb-0">
													<div class="d-flex flex-column flex-grow-1 py-2 py-lg-13 me-2">
														<a href="#" class="fw-bold text-dark fs-4 mb-2 text-hover-primary">الدروس التفاعلية</a>
